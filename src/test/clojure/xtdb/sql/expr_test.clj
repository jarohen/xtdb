...
;; TODO: Fixes needed to integer intervals
#_(t/deftest test-interval-expr
  (t/are [sql expected]
         (= expected (plan-expr-with-foo sql))
    ...
    "foo.a YEAR" '(single-field-interval f/a "YEAR" 2 6)
    "foo.a MONTH" '(single-field-interval f/a "MONTH" 2 6)
    "foo.a DAY" '(single-field-interval f/a "DAY" 2 6)
    "foo.a HOUR" '(single-field-interval f/a "HOUR" 2 6)
    "foo.a MINUTE" '(single-field-interval f/a "MINUTE" 2 6)
    "foo.a SECOND" '(single-field-interval f/a "SECOND" 2 6)

    "- foo.a SECOND" '(- (single-field-interval f/a "SECOND" 2 6))
    "+ foo.a SECOND" '(single-field-interval f/a "SECOND" 2 6)

    "foo.a YEAR + foo.b YEAR" '(+ (single-field-interval f/a "YEAR" 2 6)
                                  (single-field-interval f/b "YEAR" 2 6))
    "foo.a YEAR + foo.b MONTH" '(+ (single-field-interval f/a "YEAR" 2 6)
                                   (single-field-interval f/b "MONTH" 2 6))
    "foo.a YEAR - foo.b MONTH" '(- (single-field-interval f/a "YEAR" 2 6)
                                   (single-field-interval f/b "MONTH" 2 6))

    "foo.a YEAR + 1 MONTH" '(+ (single-field-interval f/a "YEAR" 2 6) (single-field-interval 1 "MONTH" 2 6))
    "foo.a YEAR + 1 MONTH + 2 DAY" '(+ (+ (single-field-interval f/a "YEAR" 2 6)
    ...
    "foo.a + 2 MONTH" '(+ f/a (single-field-interval 2 "MONTH" 2 6))
    "foo.a + + 1 MONTH" '(+ f/a (single-field-interval 1 "MONTH" 2 6))
    "foo.a + - 1 MONTH" '(+ f/a (- (single-field-interval 1 "MONTH" 2 6)))

    "foo.a YEAR TO MONTH" '(multi-field-interval f/a "YEAR" 2 "MONTH" 6)
    "foo.a DAY TO SECOND" '(multi-field-interval f/a "DAY" 2 "SECOND" 6)
