...
(t/deftest test-sql->put-docs-3484
  ...
  (t/is (= [(tx-ops/map->PutDocs {:table-name "public/foo", :docs [{"_id" 1} {"_id" 2}]
                                  :valid-from #xt.time/instant "2020-07-31T23:00:00Z"})
            (tx-ops/map->PutDocs {:table-name "public/foo", :docs [{"_id" 3}]
                                  :valid-from #xt.time/instant "2021-01-01T00:00:00Z"})]
  ...
  (t/testing "with args"
    (t/is (= [(tx-ops/map->PutDocs {:table-name "public/foo", :docs [{"_id" 1} {"_id" 3}]
                                    :valid-from #xt.time/instant "2020-01-01T00:00:00Z"})
              (tx-ops/map->PutDocs {:table-name "public/foo", :docs [{"_id" 2} {"_id" 4}]
                                    :valid-from #xt.time/instant "2020-01-02T00:00:00Z"})]
