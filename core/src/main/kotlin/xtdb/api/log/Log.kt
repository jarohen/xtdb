...
typealias FilesAddedNotification = Collection<Path>
...
interface Log : AutoCloseable {
    ...
    interface Factory {
        ...
        fun openFileLog(): FileLog = FileLog.openLocal()
    }

    val latestSubmittedOffset: LogOffset

    fun appendMessage(headers: Map<String, ByteArray>, payload: ByteBuffer): CompletableFuture<LogOffset>
