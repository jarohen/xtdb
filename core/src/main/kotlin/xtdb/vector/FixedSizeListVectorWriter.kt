...
class FixedSizeListVectorWriter(override val vector: FixedSizeListVector, private val notify: FieldChangeListener?) : IVectorWriter {
...
//        return writerFor(newVec, ::upsertElField).also { elWriter = it }
        TODO("replaceDataVector not supported in FixedSizeListVector")
    }
