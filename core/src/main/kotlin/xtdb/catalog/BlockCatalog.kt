...
class BlockCatalog(
    ...
    fun buildBlock(
        ...
        latestReplicaMsgId: MessageId? = null
    ): Block {
        ...
        return block {
            ...
            latestReplicaMsgId?.let { this.latestReplicaMsgId = it }
        }
    }
    ...
    val latestReplicaMsgId: MessageId?
        get() = latestBlock?.let { block -> block.latestReplicaMsgId.takeIf { block.hasLatestReplicaMsgId() } }
